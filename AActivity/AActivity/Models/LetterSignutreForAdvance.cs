...
{
    public class LetterSignutreForAdvance
    {
        public int Id { get; set; }
        [Required(ErrorMessage = "{0} مطلوب"), Display(Name = "رقم الخطاب ")]
        public int LetterAdvancedDelegationId { get; set; }
        [Display(Name = " رقم الخطاب "), ForeignKey("LetterAdvancedDelegationId")]
        public LetterAdvancedDelegation Letter { get; set; }
